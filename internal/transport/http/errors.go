...
var errorMappings = []errorMapping{
	...
	{application.ErrLifecycleHeadConflict, http.StatusConflict, "lifecycle_head_conflict", true},
	...
	{application.ErrLifecycleTransitionInvalid, http.StatusUnprocessableEntity, "lifecycle_transition_invalid", true},
